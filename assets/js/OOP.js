...
// UML - графічна мова яка дозволяє описати структуру класів
// UML - уніфікована мова моделювання що використовується в парадигміі ООП в програмуванні
// тобто це мова за допомогою якої можна графічно побудувати діаграми взаємодії класів (Діаграми класів)

// наприклад батьківський клас (його методи та властивості(публічні чи захищені) - дочірні класи що від нього спадкуються (їх методи та властивості (публічні чи захищені) який клас з яким взаємодіє та яким чином, хто з класів які методи перевикористовує а які ні, абстарктні класи, тощо))
// можна загуглити картинки цих діаграм щоб побачити наглядно
...
// ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                ...
                // Паттерни проектування та принципи SOLID

                // https://refactoring.guru/uk

// ООП це складна і важка система, яку новачку важко освоїти, для цього потрібна практика та досвід, оскільки ця парадигма є дуже широкою
// Але можна погляблювати свої значння дізнаючись про всякі корисні речі речі за допомогою всяких паттернів проектування (правила організації, рішення, тощо)
// також треба почитати про антипаттерни (як нетреба проектувати), теж дуже корисно почитати




// Також є такі базові принципи ООП - SOLID (це абревіатура - з кожного закладеного в неї принципа)
// SOLID використовується для розробки таких програмних систем, які з великою ймоврністю зможуть тривалий час розвиватись, розширятись і підтримуватись
// тут не про конкретні рішення йдеться а про практики і підходи
